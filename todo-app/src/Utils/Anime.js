...
function fitElementToParent(el, padding) {
  ...
  class Anime extends Component{
    render(){
      // return(
      //   <button onClick="this.start">8===B</button> 
      //   <div className="animation-wrapper">
      //   <div className="sphere-animation">
      //     <svg className="sphere" viewBox="0 0 440 440" stroke="rgba(80,80,80,.35)" onLoad={this.start}>
      //       <defs>
      //         <linearGradient id="sphereGradient" x1="5%" x2="5%" y1="0%" y2="15%">
      //           <stop stop-color="#cfcfc8" offset="0%"/>
      //           <stop stop-color="#b8b8b0" offset="50%"/>
      //           <stop stop-color="#cfcfc8" offset="100%"/>
      //         </linearGradient>
      //       </defs>
